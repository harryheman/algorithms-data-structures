...
describe('Matrix', () => {
  it('должен выбросить исключения при умножении матриц неправильной формы', () => {
  ...
  it('должен вычислить направления матриц', () => {
  ...
  it('должен сгенерировать матрицу нулей', () => {
  ...
  it('должен сгенерировать матрицу с определенными значениями', () => {
  ...
  it('должен сгенерировать определенную матрицу на основе указанных индексов ячеек', () => {
  ...
  it('должен выбросить исключения при сложении матриц разных форм', () => {
  ...
  it('должен выбросить исключения при умножении матриц разных форм', () => {
  ...
  it('должен выбросить исключения при вычитании матриц разных форм', () => {
